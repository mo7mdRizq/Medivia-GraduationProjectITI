...
const defaultLabResults = [
    {
        ...
        expanded: true,
        results: [
            { name: 'White Blood Cells', value: '7.2 K/┬╡L', range: '4.8 - 11 K/┬╡L', status: 'normal' },
            ...
            { name: 'Platelets', value: '245 K/┬╡L', range: '150 - 450 K/┬╡L', status: 'normal' }
        ]
    },
    {
        id: 2,
...
const getStoredLabResults = () => {
    return db.get(STORAGE_KEY) || defaultLabResults
}
